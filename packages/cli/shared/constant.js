...
exports.UI_DIR = resolve(this.CWD, '../bb-ui/ui');
exports.UI_NAMESPACE = 'b';
exports.CSS_CLASS_PREFIX = 'bbui';
...
exports.VUE_UI_FILE_NAME = 'vue-bbui.ts';
exports.VUE_UI_FILE = resolve(this.UI_DIR, this.VUE_UI_FILE_NAME);
exports.SITES_DIR = resolve(this.CWD, '../bb-ui/docs');
