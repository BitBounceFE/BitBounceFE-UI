...
import { messageBoxProps, MessageBoxProps, messageBoxEmits } from './message-box-types';
...
export default defineComponent({
  ...
  setup(props: MessageBoxProps, { slots, attrs, emit }) {
    ...
    //延迟关弹窗
    const closeMessageBoxDelay:(closeDelay:number)=>void=(closeDelay:number)=>{
      if(closeDelay>0){
        handleDelay(()=>{
          isShow.value=false
          emit("close")
