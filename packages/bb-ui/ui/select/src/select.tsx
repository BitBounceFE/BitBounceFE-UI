 ...
 * @LastEditTime: 2023-01-30 21:25:10
...
export default defineComponent({
  ...
  setup(props: SelectProps, ctx) {
    ...
    const boxclass1 = ns.e('content');
    // 点击li后更新input中的值

    const handleIsShow = (e) => {
      // console.log(e.target.getAttribute('value'));
      // if(e.target.getAttribute('disabled'))
      if (e.target.className === 'li_disabled') {
        return;
      }
    ...
    return () => (
      <div
        class={boxclass + ' ' + ns.e(props.size)}
      ...
      >
        {props.searchable ? (
          <input
            ...
            ref={input}
            class={props.disabled ? `${ns.e('disabled')}` : ``}
            onInput={changeArr}
          />
        ) : (
          <input
